...
const config = {
  ...
  feishuConsultScope: process.env.FEISHU_CONSULT_SCOPE || null,
  feishuPassportAppId: process.env.FEISHU_PASSPORT_APP_ID || '1',
  feishuAutoSsoDomain: process.env.FEISHU_AUTO_SSO_DOMAIN || null,
